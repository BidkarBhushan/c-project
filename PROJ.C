...
int main()
{
	...
	do
	{
		...
		{
		case 1:
			printf("______________Personal Information______________");
			printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
			printf("\nName   : Bhushan Ravindra Bidkar ");
			printf("\nAge    : 18   ");
			printf("\nStd    : SYBCA-  (SEM=3)");
			printf("\nPhone  : 9021875273");
			printf("\nEmail  : bidkarbhushan201@gmail.com");
			printf("\nAddress: Bharatsing Nagar, Shirpur (425-405)");
			printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
		...
		case 2: printf(":::::::::::::::::::::::::::HSC Marksheet:::::::::::::::::::::::::::\n");
			    ...
			    printf("\nTotal Marks : 522/600          Percentage : 80% ");
			    printf("\nResult : pass");

			    break;

		case 3:
			printf("\t\tR.C Patel Institute Of Management Research And Devlopment, Shirpur\n");
			printf("***********************************Timetable*******************************************\n");
	...
	do{
	    ...
	    {
		case 1 :
			printf("\nFor Addition of 2 Integer Numbers");
			printf("\n\nEnter First Number = ");
			scanf("%d",&n1);
			printf("\nEnter Second Number = ");
			scanf("%d",&n2);
		...
		case 2 :
			printf("\nFor Addition of 2 Float Numbers");
			printf("\nEnter First Number = ");
			scanf("%f",&num1);
			printf("\nEnter Second Number = ");
			scanf("%f",&num2);
